...
df = pd.read_csv("./data/ProtSpatial/protein_data raw.csv", index_col=0)

# csv_path = f"./data_exploration/data/ProtSpatial/{model_name}_embeddings.csv"
csv_path = f"./data/ProtSpatial/{model_name}_embeddings.csv"
# merge data
...
df_final.nunique()
df_final.to_csv(f"./data/ProtSpatial/protein_data{model_name}_final.csv")