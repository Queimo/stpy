...
for i, lam in enumerate(lambdas):
    GPt = GaussianProcess(gamma=gamma, kernel_name="squared_exponential", d=d, loss='amini', lam=lam)
    GPt.fit_gp(x2, y2)
...
GPt = GaussianProcess(gamma=gamma, kernel_name="squared_exponential", d=d, loss='amini', lam=lambdas[0])
GPt.fit_gp(x2, y2)
